...
public:
    ...
    int maxhealth = 0;
    int currenthealth = 0;
    double total_distance = 0; //for a specific survivor only
    ...
    //void randHealth();
    //void randImmunity();
    void movesurvivor(FILE* plot, int id); // Returns distance travelled per step
    double getTotalDistance();
    void setHealth(int newHealth);
    void GetInfo();
    int detect_Hit(std::vector<std::array<double,2>> coords_list, double radius);
