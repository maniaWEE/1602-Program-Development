...
public:
    ...
    void generateCoords(); //generate new coordinates, MUST RUN ONCE BEFORE MAIN PROG FOR FIRST SET OF RESOURCES

    //to interact with survivor
    int make_decision(double currentHealth); //return new health of survivor
