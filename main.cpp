...
int main()
{
    ...
    for (size_t i = 0; i < stepLengthGraph_win.size(); i++){
        std::cout << "StepLength (win): " << stepLengthGraph_win[i] << std::endl;
    }

    for (size_t i = 0; i < distanceGraph_win.size(); i++){
        std::cout << "Distance (win): " << distanceGraph_win[i] << std::endl;
    }

    for (size_t i = 0; i < stepLengthGraph_lose.size(); i++){
        std::cout << "StepLength (lose): " << stepLengthGraph_lose[i] << std::endl;
    }

    for (size_t i = 0; i < distanceGraph_lose.size(); i++){
        std::cout << "Distance (lose): " << distanceGraph_lose[i] << std::endl;
    }
